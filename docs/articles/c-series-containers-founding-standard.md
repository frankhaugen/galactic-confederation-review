...
1. visible symbols for common handling classes
2. tactile marks for low-visibility and suit operations
3. machine-readable hazard codes
4. registry-linked handling instructions
5. mandatory incompatible-cargo declarations
